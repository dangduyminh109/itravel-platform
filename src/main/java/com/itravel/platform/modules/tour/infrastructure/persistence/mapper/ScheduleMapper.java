...
public interface ScheduleMapper {
    ...
    static Schedule toScheduleDomain(ScheduleJpaEntity entity) {
        ...
        return Schedule.fromExistingBuilder()
                ...
                .seats(new ScheduleSeats(entity.getTotalSeats(), entity.getBookedSeats(), entity.getLockedSeats()))
                .pricing(new Pricing(
                        entity.getAdultPrice() != null ? new TicketPrice(entity.getAdultPrice().getOriginalPrice(), entity.getAdultPrice().getDiscountPrice()) : null,
                        entity.getChildPrice() != null ? new TicketPrice(entity.getChildPrice().getOriginalPrice(), entity.getChildPrice().getDiscountPrice()) : null,
                        entity.getInfantPrice() != null ? new TicketPrice(entity.getInfantPrice().getOriginalPrice(), entity.getInfantPrice().getDiscountPrice()) : null,
                        entity.getSingleSupplement(),
                        entity.getCurrency() != null ? CurrencyCode.valueOf(entity.getCurrency()) : CurrencyCode.VND)
                )
    ...
    static ScheduleDetailDTO toScheduleDetailDTO(ScheduleJpaEntity entity) {
        if (entity == null) return null;
        ScheduleSeats seats = new ScheduleSeats(entity.getTotalSeats(), entity.getBookedSeats(), entity.getLockedSeats());
